...
const ssize_t repovalidator::POS_SIG_VALUE  = -1;
const ssize_t repovalidator::POS_SIG_INFO   = -2;
const ssize_t repovalidator::POS_RANDOM_VAL = -3;
const ssize_t repovalidator::POS_TIMESTAMP  = -4;
const int64_t repovalidator::GRACE_INTERVAL = 3000;
