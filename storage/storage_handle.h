...
public:
	...
	virtual int insert_data(const Interest& interest, Data &data) = 0;
	virtual int delete_data(const Name& name) = 0;
	...
	virtual int check_name_any(const Name& name, const Selectors& selectors, vector<Name>& vname) = 0;
private:
